...
#======== segunda guerra ===========#
pib_lad               <- c("1939", "1939",  "1940.1", "1940.2", "1941.1", "1941.2", "1942", "1943", "1944.1", "1944.2", "1945") 
pib_tot               <- data.frame("Aliados"   = c(470, 486, 398, 316,344,703,1906,2224,2457,2550,2394),
                                    "Eixo   "   = c(544, 595, 606, 835, 911, 911, 902, 895,748,655, 466))
col.names(pib_tot)    <- pib_lad
